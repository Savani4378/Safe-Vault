    ...
    <div className="min-h-screen bg-deep bg-radial-gradient flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="font-mono text-[14px] text-cyan tracking-[2px] mb-10 flex justify-center items-center gap-2.5">
          <span className="w-3 h-3 bg-cyan shadow-cyan block"></span> VAULTGUARD v2.4
        </div>

        <p className="text-center text-tx-dim mb-8 text-[11px] font-mono uppercase tracking-[1px]">Provide Authorization PIN</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {loading ? 'AUTHENTICATING...' : 'MOUNT SYSTEM'}
          </button>
        </form>
      </motion.div>
    </div>
